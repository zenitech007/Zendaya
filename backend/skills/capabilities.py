...
def _ha_status():
    try:
        from integrations.home_assistant import ha_available, ha_configured
...
def _kdec_status():
    try:
        from integrations.phone import kdec_installed, kdec_available
...
def _spotify_status():
    try:
        from integrations.spotify import spotify_configured, spotify_available
