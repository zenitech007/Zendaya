"""
skills.proactive — ambient check-in scheduler.
...
Runs on a background daemon thread and lets Zendaya speak first when:
  ...
  5. A calendar event from integrations.google_apis is starting within 10min.
...
def _upcoming_calendar_event() -> Optional[dict]:
    ...
    try:
        import integrations.google_apis as _g
    except Exception:
        return None
