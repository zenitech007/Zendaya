...
export function fadeSubtree(root, target, duration = DUR.base, ease = EASE.cinematic) {
    if (!root)
...
export function tweenUniform(mat, uniform, target, duration = DUR.base, ease = EASE.cinematic) {
