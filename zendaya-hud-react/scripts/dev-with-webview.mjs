...
// WebView2 install on this machine is broken, so dev mode would otherwise
// flash a window and die. The bundled runtime is only auto-used by
// `tauri build` via fixedRuntime; dev needs this env var.
