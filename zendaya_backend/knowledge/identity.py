...
# AI Identity
AI_IDENTITY = {
    "short_name": "Z.E.N.D.A.Y.A.",
    "full_name": "Zettascale Engine for Neural Decision-making and Autonomous Yield Augmentation",
    "introductions": {
...
def get_introduction(style: str = None) -> str:
    """
    Return an introduction string.
    If style is None, pick a random one.
    """
    styles = AI_IDENTITY["introductions"]
